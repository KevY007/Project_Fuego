...
static void ini_init ( void )
{
	...
	set.actBrkDance = 0;
	set.lockedcaresp = 0;
	set.smarthealthhack = 0;
	set.smarthhproc = 30;
	set.default_nametags = 0;
	set.weaponFinder = 0;
	set.autounscramble = 0;
	set.autounscramble_delay = 1250;
	...
	set.nearslapper_friendFilter = 1;

	set.killer_enabled = 0;
	set.killer_delay = 250;
	set.killer_cur = 0;
	set.killer_lastTick = -1;
	set.killer_bullets = 1;
	...
	set.killer_counter_tick = GetTickCount();
	set.killer_counter_updatetime = 1;
	set.killer_friendFilter = 1;

	set.fakesynclag = 0;
	set.fakesynclag_delay = 250;
	set.fakesynclag_randomspikes = 0;
	set.fakesynclag_onceperms = 0;

	set.silentaim = 0;
	set.silentaim_letGo = false;
	set.silentaim_afkFilter = 1;
	set.silentaim_friendFilter = 1;
	set.silentaim_aliveFilter = 1;
	set.silentaim_colorFilter = 0;
	set.silentaim_iAimID = -1;
	set.silentaim_outOfRangeFilter = 0;
	set.silentaim_lastAimDist = 0.0;
	set.silentaim_skinFilter = 0;
	set.silentaim_fov = 75;
	set.silentaim_teamFilter = 0;
	set.silentaim_antiAimBypass = 0;
	set.silentaim_drawTracer = set.TRACERTYPE::Off;
	...
	if ((ent = ini_register_entry("key_blinking_car_lights", TYPE_KEYCOMBO)) != NULL)
		ini_register_data(ent, &set.key_blinking_car_lights, "f22");
	...
	*/
	...
	if ((ent = ini_register_entry("fly_player_speed", TYPE_FLOAT)) != NULL)
		ini_register_data(ent, &set.fly_player_speed, "0.85");
	if ((ent = ini_register_entry("fly_player_accel_multiplier", TYPE_FLOAT)) != NULL)
		ini_register_data(ent, &set.fly_player_accel_multiplier, "0.75");
	if ((ent = ini_register_entry("fly_player_decel_multiplier", TYPE_FLOAT)) != NULL)
		ini_register_data(ent, &set.fly_player_decel_multiplier, "1.5");
	...
	*/
	...
	if ((ent = ini_register_entry("money_value", TYPE_INT)) != NULL)
		ini_register_data(ent, &set.money_value, "0");
	...
	if ((ent = ini_register_entry("key_atbmenu", TYPE_KEYCOMBO)) != NULL)
		ini_register_data(ent, &set.key_atbmenu, "f2");

	if ((ent = ini_register_entry("no_big_hacks", TYPE_BOOL)) != NULL)
		ini_register_data(ent, &set.noBigHacks, "false");
	...
	if ((ent = ini_register_entry("nametag_type", TYPE_INT)) != NULL)
		ini_register_data(ent, &set.default_nametags, "0");
	...
	if ((ent = ini_register_entry("esp_players_defaulton", TYPE_BOOL)) != NULL)
		ini_register_data(ent, &set.esp_players_defaulton, "false");
