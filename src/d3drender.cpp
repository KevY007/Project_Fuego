...
void CD3DRender::Circle(int X, int Y, int radius, int numSides, D3DCOLOR Color)
{
...
void CD3DRender::CircleOutlined(int X, int Y, int radius, int numSides, float outlinewidth, D3DCOLOR Color, D3DCOLOR Outline)
{
