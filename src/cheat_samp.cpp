...
bool OnSendPacket(BitStream *parameters, PacketPriority priority, PacketReliability reliability, char orderingChannel)
{
	...
	if (set.slapkill && !isCheatPanicEnabled())
	{
...
void initChatCmds(void)
{
	...
	addClientCommand("fuego_change_server", cmd_change_server);
	addClientCommand("fuego_fav_server", cmd_change_server_fav);
	addClientCommand("fuego_current_server", cmd_current_server);
	addClientCommand("fuego_tele_loc", cmd_tele_loc);
	addClientCommand("fuego_teleport_location", cmd_tele_loc);
	addClientCommand("fuego_tele_locations", cmd_tele_locations);
	addClientCommand("fuego_teleport_locations", cmd_tele_locations);
	addClientCommand("fuego_pickup", cmd_pickup);
	addClientCommand("fuego_setclass", cmd_setclass);
	addClientCommand("fuego_fakekill", cmd_fakekill);
