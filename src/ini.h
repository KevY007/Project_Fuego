...
struct settings
{
	...
	*/
	...
	uint8_t					shotrepeater;
	int						fakeheadshot;
	int						aimslapper;
	uint8_t					aimslapperspeed;
	int						inviszdown;
	int						smartinvis;
	uint8_t					iTroll;
	uint32_t				iTroll_Target;
	std::string				iTroll_Targetname;
	int						carshooter;
	int						nearslapper;
	int						nearslapper_friendFilter;
	int						removecars;
	int						explodecars;
	int						carsfloating;
	int						explodecarssilent;
	int						unoccupiedremover;
	BYTE					byteSlapperState;
	int						freeze;
	uint32_t				freeze_target;
	float					freeze_pos[3];
	...
	int						killer_enabled;
	int						killer_friendFilter;
	int						killer_cur;
	UINT32					killer_delay;
	DWORD					killer_lastTick;
	int						killer_bullets;
	int						killer_counter_players;
	int						killer_counter_bullets;
	DWORD					killer_counter_tick;
	int						killer_counter_updatetime;

	int						fakesynclag;
	int						fakesynclag_delay;
	int						fakesynclag_randomspikes;
	int						fakesynclag_onceperms;

	int						nospread;
	int						nospread_trigger;
	int						nospread_triggers;
	bool					nospread_go;
	int						noreload;
	int						triggerbot;
	int                     dShotStatus;
	...
	int						vunlockerenter;
	int						clickwarping;
	int						attachingtrailer;
	int						attachingtrailerenter;
	int						damagingcardoorenter;
	int						silentaim;
	int						smarthealthhack;
	int						smarthhproc;
	int						default_nametags;
	int						silentaim_iAimID;
	float					silentaim_lastAimDist;
	bool					silentaim_letGo;
	int						silentaim_shotWall;
	int						silentaim_fov;
	int						silentaim_teamFilter;
	int						silentaim_colorFilter;
	int						silentaim_skinFilter;
	int						silentaim_afkFilter;
	int						silentaim_aliveFilter;
	int						silentaim_outOfRangeFilter;
	int						silentaim_antiAimBypass;
	typedef enum { Off, ESP, ESPFOV } TRACERTYPE;
	TRACERTYPE				silentaim_drawTracer;
	int						silentaim_friendFilter;
	int						noBigHacks;
	int						weaponFinder;
	int						actBrkDance;
	int						autounscramble;
	DWORD					autounscramble_delay;
